...
import { ListStudentsQuery, UpdateStudentDto, FreezeSubscriptionDto, GrantSubscriptionDto, CreateVideoDto, UpdateVideoDto, UpdatePlanDto, UpdateSubjectDto, CreateSubjectDto, CreateTeacherDto, TeacherCredentialsDto } from './dto/admin.dto';
export declare class AdminController {
    ...
    freezeSubscription(id: string, dto: FreezeSubscriptionDto): Promise<{
        id: string;
        isActive: boolean;
        createdAt: Date;
        userId: string;
    ...
    updateVideo(id: string, dto: UpdateVideoDto): Promise<({
        questions: {
            id: string;
            createdAt: Date;
            videoId: string;
    ...
    updateTeacherCredentials(id: string, dto: TeacherCredentialsDto): Promise<{
        success: boolean;
    }>;
